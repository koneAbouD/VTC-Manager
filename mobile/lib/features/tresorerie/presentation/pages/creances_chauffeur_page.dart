...
/// Détail des documents ouverts d'un chauffeur, tous modules confondus.
/// Le tap sur une ligne rouvre le flux d'encaissement du module d'origine.
class CreancesChauffeurPage extends ConsumerWidget {
  final int chauffeurId;
  final String chauffeurNom;

  const CreancesChauffeurPage({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncLignes = ref.watch(creancesChauffeurProvider(chauffeurId));

    return Scaffold(
      backgroundColor: AppColors.scaffold,
      appBar: AppHeader(title: chauffeurNom),
        ...
        error: (e, _) => Center(
          child: Column(
            ...
            children: [
              ...
              TextButton.icon(
                onPressed: () =>
                    ref.invalidate(creancesChauffeurProvider(chauffeurId)),
