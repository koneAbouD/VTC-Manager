...
class _ReglementSheetState extends ConsumerState<_ReglementSheet> {
  late final TextEditingController _montantCtrl = TextEditingController(
      text: widget.facture.restantDu.toStringAsFixed(0));
  ...
  Future<void> _valider() async {
    ...
    try {
      await ref.read(fournisseurDatasourceProvider).reglerFacture(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Régler ${f.fournisseurNom ?? "la facture"}',
            ...
            const SizedBox(height: 16),
            _Ligne('Montant de la facture', CurrencyFormatter.format(f.montant)),
            if (f.montantPaye > 0)
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                errorText: _montant > f.restantDu
                    ? 'Au-delà du restant dû'
                    : null,
              ),
            ),
