...
class _FormState extends ConsumerState<OperationFinanciereFormPage> {
  ...
  Widget _buildModePaiementToggle() {
    return Row(
      children: ModePaiement.values.map((m) {
        ...
        final icon =
            isEspeces ? Icons.payments_outlined : Icons.phone_android_outlined;
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isSel ? _kPrimary.withValues(alpha: 0.10) : _kFieldFill,
              ...
              child: Row(
                ...
                children: [
                  Icon(icon,
                      size: 15,
                      color: isSel ? _kPrimary : _kHint.withValues(alpha: 0.6)),
        ...
        return Expanded(
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 8),
              decoration: BoxDecoration(
                color: isSel ? color.withValues(alpha: 0.10) : _kFieldFill,
                borderRadius: BorderRadius.circular(10),
                border: Border.all(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 7,
                    decoration: BoxDecoration(
                      color: isSel ? color : _kHint.withValues(alpha: 0.35),
  ...
  void _updateMontantFromElements(List<ElementMaintenance> elements) {
    final total = elements.fold(0.0, (sum, e) => sum + e.montant);
    _montantCtrl.text = total > 0 ? total.toStringAsFixed(0) : '';
  }
        ...
        if (_elements.isNotEmpty) ...[
          ..._elements.map((el) => Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(
                    color: const Color(0xFFE65100).withValues(alpha: 0.20),
                  ),
                ),
                child: Row(
                  children: [
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            const Icon(Icons.keyboard_arrow_down, size: 20, color: _kHint),
          ],
        ),
      ),
    );
  ...
  InputDecoration _fieldDeco(String hint) => InputDecoration(
        ...
        errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: _kDepense, width: 1.5),
        ),
                ...
                children: [
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Row(children: [
                              ...
                              AnimatedRotation(
                                turns: _maintenanceExpanded ? 0.5 : 0.0,
                  ...
                  _LabeledField(
                    ...
                    child: TextFormField(
                      ...
                      maxLines: 3,
                      style: const TextStyle(fontSize: 15, color: _kDark),
                      decoration: _fieldDeco('Informations complémentaires…'),
                    ),
                  ),
                ],
              ),
