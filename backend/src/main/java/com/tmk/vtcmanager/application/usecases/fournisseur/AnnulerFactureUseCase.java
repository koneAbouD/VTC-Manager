...
public class AnnulerFactureUseCase {
    ...
    @Transactional
    public FactureFournisseur executer(Long factureId, String motif) {
        ...
        if (facture.getStatut() == StatutFactureFournisseur.ANNULEE) {
        ...
        facture.setStatut(StatutFactureFournisseur.ANNULEE);
