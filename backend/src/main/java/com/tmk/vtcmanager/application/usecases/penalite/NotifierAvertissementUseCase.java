...
public class NotifierAvertissementUseCase {
    ...
    public LignePenalite executer(Long id) {
        ...
        if (!ligne.isNotifiable()) {
            throw new LignePenaliteNonNotifiableException(id);
        }

        lignePenaliteRepository.updateStatut(id, StatutLignePenalite.NOTIFIEE);
