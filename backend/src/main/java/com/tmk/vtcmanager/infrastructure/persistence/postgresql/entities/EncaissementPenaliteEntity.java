...
@Entity
@Table(name = EncaissementPenaliteEntity.TABLE_NAME)
@Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
public class EncaissementPenaliteEntity extends AbstractEcritureAuditEntity {

    public static final String TABLE_NAME = "encaissements_penalite";
    ...
    @JoinColumn(name = "ligne_penalite_id", nullable = false)
    private LignePenaliteEntity lignePenalite;
