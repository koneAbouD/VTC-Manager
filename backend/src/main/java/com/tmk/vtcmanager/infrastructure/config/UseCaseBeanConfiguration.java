...
public class UseCaseBeanConfiguration {
    ...
    @Bean
    public DeleteOperationFinanciereUseCase deleteOperationFinanciereUseCase(OperationFinanciereRepository repo) {
        return new DeleteOperationFinanciereUseCase(repo);
    }
