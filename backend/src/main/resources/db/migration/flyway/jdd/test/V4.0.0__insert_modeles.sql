-- Insertion des modèles pour l'environnement de test
-- Les marques de camions ont des noms distincts (ex: "Renault Trucks") donc pas d'ambiguïté.
-- Les marques présentes en Voiture ET Moto (BMW, Honda, Suzuki) utilisent un filtre sur type_id.
...
('T', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Renault Trucks'), NOW(), NOW()),
('K', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Renault Trucks'), NOW(), NOW()),
('C', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Renault Trucks'), NOW(), NOW()),
('D', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Renault Trucks'), NOW(), NOW()),

-- Volvo Trucks (camions)
('FH',  (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Volvo Trucks'), NOW(), NOW()),
('FM',  (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Volvo Trucks'), NOW(), NOW()),
('FMX', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Volvo Trucks'), NOW(), NOW()),

-- Mercedes-Benz Trucks (camions)
('Actros', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Mercedes-Benz Trucks'), NOW(), NOW()),
('Atego',  (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Mercedes-Benz Trucks'), NOW(), NOW()),
('Econic', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Mercedes-Benz Trucks'), NOW(), NOW()),

-- Iveco (camions)
('Stralis',   (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Iveco'), NOW(), NOW()),
('Eurocargo', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Iveco'), NOW(), NOW()),
('Daily',     (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Iveco'), NOW(), NOW()),

-- MAN (camions)
('TGX', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'MAN'), NOW(), NOW()),
('TGS', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'MAN'), NOW(), NOW()),
('TGM', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'MAN'), NOW(), NOW()),

-- Scania (camions)
('R-series', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Scania'), NOW(), NOW()),
('S-series', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Scania'), NOW(), NOW()),
('P-series', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Scania'), NOW(), NOW()),

-- DAF (camions)
('XF', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'DAF'), NOW(), NOW()),
('CF', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'DAF'), NOW(), NOW()),
('LF', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'DAF'), NOW(), NOW()),

-- Suzuki Trucks (camions)
('Carry',       (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Suzuki Trucks'), NOW(), NOW()),
('Every',       (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Suzuki Trucks'), NOW(), NOW()),
('Scrum',       (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Suzuki Trucks'), NOW(), NOW()),
('Jimny Truck', (SELECT id FROM types_vehicule WHERE nom = 'Camion'), (SELECT id FROM marques WHERE nom = 'Suzuki Trucks'), NOW(), NOW()),

-- Piaggio (tricycles)
('Ape',    (SELECT id FROM types_vehicule WHERE nom = 'Tricycle'), (SELECT id FROM marques WHERE nom = 'Piaggio'),  NOW(), NOW()),
('Porter', (SELECT id FROM types_vehicule WHERE nom = 'Tricycle'), (SELECT id FROM marques WHERE nom = 'Piaggio'),  NOW(), NOW()),

-- Aixam (tricycles)
('City',  (SELECT id FROM types_vehicule WHERE nom = 'Tricycle'), (SELECT id FROM marques WHERE nom = 'Aixam'),     NOW(), NOW()),
('Cross', (SELECT id FROM types_vehicule WHERE nom = 'Tricycle'), (SELECT id FROM marques WHERE nom = 'Aixam'),     NOW(), NOW()),

-- Ligier (tricycles)
('JS50', (SELECT id FROM types_vehicule WHERE nom = 'Tricycle'), (SELECT id FROM marques WHERE nom = 'Ligier'),     NOW(), NOW()),
('JS60', (SELECT id FROM types_vehicule WHERE nom = 'Tricycle'), (SELECT id FROM marques WHERE nom = 'Ligier'),     NOW(), NOW()),

-- Microcar (tricycles)
('M.Go',        (SELECT id FROM types_vehicule WHERE nom = 'Tricycle'), (SELECT id FROM marques WHERE nom = 'Microcar'), NOW(), NOW()),
('M.Go Family', (SELECT id FROM types_vehicule WHERE nom = 'Tricycle'), (SELECT id FROM marques WHERE nom = 'Microcar'), NOW(), NOW());